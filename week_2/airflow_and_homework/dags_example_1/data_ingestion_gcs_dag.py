...
def upload_to_gcs(bucket, object_name, local_file): 
    # Workaround to prevent timeout for files
...
with DAG(
    ...
    download_dataset_task = BashOperator(
        ...
        bash_command=f'curl -LsS {dataset_url} > {path_to_local_home}/{dataset_file}'
    )
    ...
    bigquery_externam_table_task = BigQueryCreateExternalTableOperator(
    ...
    download_dataset_task >> format_to_parquet >> local_to_gcs_task >> bigquery_externam_table_task