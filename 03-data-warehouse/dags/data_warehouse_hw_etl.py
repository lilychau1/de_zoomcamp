...
from ingest_data import concat_parquets_and_transform_callable
from gcp_operations import upload_to_gcs
...
with local_workflow:
    ...
    local_to_gcs_task = PythonOperator(
        ...
        op_kwargs={
            ...
            'table_name': f'{TABLE_NAME}/{OUTPUT_FILE_NAME}',
    ...
    wget_task >> concat_parquet_and_transform_task >> local_to_gcs_task
